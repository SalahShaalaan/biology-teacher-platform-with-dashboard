...
//             <CardHeader>
//               <CardTitle>معلومات الشرح الأساسية</CardTitle>
//               <CardDescription>
//                 تحديث عنوان الشرح والمعلومات المتعلقة به.
//               </CardDescription>
//             </CardHeader>
...
//                 render={({ field }) => (
//                   <FormItem>
//                     <FormLabel>وصف الشرح</FormLabel>
//                     <FormControl>
//                       <Textarea
//                         placeholder="اكتب وصفًا موجزًا للشرح..."
...
//                       <FormControl>
//                         <Input placeholder="مثال: الوحدة الأولى" {...field} />
//                       </FormControl>
//                       <FormMessage />
//                     </FormItem>
//                   )}
...
//                       <FormControl>
//                         <Input placeholder="مثال: الدرس الأول" {...field} />
//                       </FormControl>
//                       <FormMessage />
//                     </FormItem>
//                   )}
...
export function EditBlogForm({ initialData }: { initialData: Blog }) {
  ...
  const form = useForm<BlogFormData>({
    ...
    defaultValues: {
      ...
      videoFile: undefined,
      learningOutcomes:
        initialData.learningOutcomes && initialData.learningOutcomes.length > 0
          ? initialData.learningOutcomes.map((value) => ({ value }))
          : [{ value: "" }],
    },
  });
